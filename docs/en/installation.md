...
The chart points by default to `ghcr.io/cofrap-epsi-2026/<function>:0.1.0`. Those images only exist **once a git tag `v0.1.0` has been pushed** (the [`release.yml`](../../.github/workflows/release.yml) workflow builds and pushes them on that tag).
