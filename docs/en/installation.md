...
The chart points by default to `ghcr.io/cofrap-epsi-2026/<function>:2026.1.1`. Those images only exist **once a git tag `v2026.1.1` has been pushed** (the [`release.yml`](../../.github/workflows/release.yml) workflow builds and pushes them on that tag).
